...
class CactusClient {
    constructor(baseUrl, token) {
        ...
        this.customer = new _ressources_1.CustomerRessource(
            this.instanceParams
        );
        this.advancedAuth = new _ressources_1.AdvancedAuthRessource(
            this.instanceParams
        );
        this.passwordReset = new _ressources_1.PasswordResetRessource(
            this.instanceParams
        );
        this.ticket = new _ressources_1.TicketRessource(this.instanceParams);
        this.pspPrice = new _ressources_1.PspPriceRessource(
            this.instanceParams
        );
        this.beneficialOwner = new _ressources_1.BeneficialOwnerRessource(
            this.instanceParams
        );
        this.beneficiary = new _ressources_1.BeneficiaryRessource(
            this.instanceParams
        );
        ...
        this.contract = new _ressources_1.ContractRessource(
            this.instanceParams
        );
        this.updatePassword = new _ressources_1.UpdatePasswordRessource(
            this.instanceParams
        );
        this.upload = new _ressources_1.UploadRessource(this.instanceParams);
        this.pspBankAccount = new _ressources_1.PspBankAccountRessource(
            this.instanceParams
        );
        this.signup = new _ressources_1.SignupRessource(this.instanceParams);
        this.rateAlert = new _ressources_1.RateAlertRessource(
            this.instanceParams
        );
        this.sponsorship = new _ressources_1.SponsorshipRessource(
            this.instanceParams
        );
        this.bankAccount = new _ressources_1.BankAccountRessource(
            this.instanceParams
        );
        this.appCompatibility = new _ressources_1.AppCompatibilityResource(
            this.instanceParams
        );
    ...
    removeToken() {
        ...
        delete this.instance.defaults.headers.common[
            constants_1.AUTH_HEADER_KEY
        ];
    }
}
