...
import { LoginRessource, MyselfRessource, CustomerRessource, AdvancedAuthRessource, PasswordResetRessource, TicketRessource, PspPriceRessource, BeneficialOwnerRessource, BeneficiaryRessource, MapboxRessource, EmailRessource, OnfidoRessource, MessageRessource, ContractRessource, UpdatePasswordRessource, UploadRessource, PspBankAccountRessource, SignupRessource, RateAlertRessource, SponsorshipRessource, BankAccountRessource, AppCompatibilityResource, PhoneNumberRessource, ManagementRessource, LogoutRessource, CountriesRessource, CustomerVbanRessouce } from './ressources';
...
export declare class CactusClient {
    ...
    countries: CountriesRessource;
    customerVban: CustomerVbanRessouce;
    management: ManagementRessource;
    logoutRessource: LogoutRessource;
}
export {};
